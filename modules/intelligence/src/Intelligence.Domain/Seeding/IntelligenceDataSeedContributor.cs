    ...
    public async Task SeedAsync(DataSeedContext context)
    {
        ...
        if (await _rulesRepository.FindAsync(IntelligenceConstants.CashierReportRuleId) == null)
        {
            await _rulesRepository.InsertAsync(new AppInventoryRule(
                ...
                thresholdValue: 0,
                thresholdDays: null,
                suggestedAction: "Restock this product",
                priority: 0,
                isActive: false
            ), autoSave: true);
        }
        ...
        if (await _rulesRepository.FindAsync(IntelligenceConstants.ProductionOperationsRuleId) == null)
        {
            await _rulesRepository.InsertAsync(new AppInventoryRule(
                ...
                ruleName: "Production operations alerts",
                ruleType: InventoryRuleTypes.LowStock,
                productId: null,
                branchId: null,
                thresholdValue: 0,
                thresholdDays: null,
                suggestedAction: "Review the production dashboard and take the suggested step",
                priority: 0,
                isActive: false
            ), autoSave: true);
        }
        ...
        await _rulesRepository.InsertAsync(new AppInventoryRule(
            ...
            thresholdValue: 5,
            thresholdDays: null,
            suggestedAction: "Reorder from the default supplier or request a transfer from another branch",
            priority: 0,
            isActive: true
        ), autoSave: false);
        ...
        await _rulesRepository.InsertAsync(new AppInventoryRule(
            ...
            thresholdValue: 100,
            thresholdDays: null,
            suggestedAction: "Consider transferring the surplus to another branch",
            priority: 0,
            isActive: true
        ), autoSave: false);
        ...
        await _rulesRepository.InsertAsync(new AppInventoryRule(
            ...
            thresholdValue: null,
            thresholdDays: 30,
            suggestedAction: "Apply a 20% discount or redistribute to a busier branch",
            priority: 0,
            isActive: true
        ), autoSave: false);
        ...
        await _rulesRepository.InsertAsync(new AppInventoryRule(
            ...
            thresholdValue: 2,
            thresholdDays: null,
            suggestedAction: "URGENT: stock is critically low — reorder immediately",
            priority: 10,
            isActive: true
        ), autoSave: false);
        ...
        await _rulesRepository.InsertAsync(new AppInventoryRule(
            ...
            thresholdValue: 10,
            thresholdDays: null,
            suggestedAction: "Transfer stock from a branch that has a surplus",
            priority: 5,
            isActive: true
        ), autoSave: true);
    }
