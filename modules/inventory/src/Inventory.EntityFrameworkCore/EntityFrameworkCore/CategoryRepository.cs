...
public class CategoryRepository
    : EfCoreRepository<InventoryDbContext, AppCategory, Guid>,
      ICategoryRepository
{
    public CategoryRepository(IDbContextProvider<InventoryDbContext> dbContextProvider)
    ...
    public async Task<List<AppCategory>> GetFilteredListAsync(
        string? filter,
        bool? isActive,
        string sorting,
        int skipCount,
    ...
    private async Task<IQueryable<AppCategory>> BuildFilteredQueryAsync(string? filter, bool? isActive)
    {
