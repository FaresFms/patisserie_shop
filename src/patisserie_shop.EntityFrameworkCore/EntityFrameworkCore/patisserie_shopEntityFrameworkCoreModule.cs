...
public class patisserie_shopEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<patisserie_shopDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
             ...
             * See also patisserie_shopDbContextFactory for EF Core tooling. */
